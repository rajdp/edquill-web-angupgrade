...
export class ListTeacherComponent implements OnInit {
  public ntPassword: UntypedFormGroup;
  public listData: any;
  ...
  constructor(public nav: NavService, public category: CategoryService, public config: NgbModalConfig, public confi: ConfigurationService, private modalService: NgbModal,
              ...
              public formBuilder: UntypedFormBuilder, public loginService: LoginService, public validationService: ValidationService, public schoolSelect: SchoolselectionService) {
    ...
    bulkInsertSuccess(successData, type) {
        if (successData.IsSuccess) {
            ...
            if (type == 'upload'){
                ...
                this.toastr.success('Email Invite Sent Successfully', 'Teacher');
            }
        }
        this.commondata.showLoader(false);
    }
  ...
  uploadXL(event, fileEvent) {
    ...
    this.common.excelUpload(data).subscribe( (successData) => {
          this.uploadXLSuccess(successData,  fileEvent);
        },
        (error) => {
          this.uploadXLFailure(error);
        });
  }
  uploadXLSuccess(successData,  fileEvent) {
    if (successData.IsSuccess) {
      this.commondata.showLoader(false);
      this.getUrl = '';
      this.filetype = '';
  ...
  uploadXLFailure(error) {
    ...
    changeSuccess(successData , type) {
        if (successData.IsSuccess) {
            ...
            this.route.navigate(['Teacher/list-Teacher']);
            if (type == 1){
                        ...
                        <div class="card-body pt-2">
                            <div class="row d-flex flex-column">
                                ...
                                <table class="capital">
                                    ...
                                    <tr>
                                        <td class="pl-4"><b>Designation:</b></td>
                                        <td *ngIf="viewdetail.designation != ''">{{viewdetail.designation}}</td>
                                    </tr>
                                    <tr>
                                        <td class="pl-4"><b>Gender:</b></td>
                                        <td *ngIf="viewdetail.gender != ''">{{viewdetail.gender}}</td>
                                    </tr>
                                    <tr>
