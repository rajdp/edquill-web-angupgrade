...
import * as JXG from '../../../../../src/assets/js/jsxgraphcore.js';
@Component({
  selector: 'app-graph-component',
  templateUrl: './graph-component.component.html',
  styleUrls: ['./graph-component.component.scss']
})
export class GraphComponentComponent implements  OnInit, AfterContentInit  {

  @Input() questionType: any;
  @Input() editPatchValue: any;
  @Input() editMode: any;
  @Input() graphId: any;
  @Input() dragPoints: any = true;
