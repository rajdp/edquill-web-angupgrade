...
export class ListAdminComponent implements OnInit {
  public listData: any;
  public adminPassword: UntypedFormGroup;
  ...
  constructor(public contentService: ContentService, public config: NgbModalConfig, public confi: ConfigurationService, public validationService: ValidationService,
              private modalService: NgbModal, public auth: AuthService, public commondata: CommonDataService, public route: Router, public schoolSelect: SchoolselectionService,
              public  firstcaps: TitleCasePipe, public sanitizer: DomSanitizer, public toastr: ToastrService, public common: CommonService,
              public brandservices: SchoolService, public admin: AdminService, public loginService: LoginService, private formBuilder: UntypedFormBuilder) {
  ...
  changeSuccess(successData , type) {
    if (successData.IsSuccess) {
      ...
      this.route.navigate(['admin/list-admin']);
      if (type == 1){
