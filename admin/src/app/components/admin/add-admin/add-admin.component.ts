...
export class AddAdminComponent implements OnInit, OnDestroy {
    ...
    constructor(public route: ActivatedRoute, private formBuilder: UntypedFormBuilder, public commondata: CommonDataService, private toastr: ToastrService,
                ...
                public config: ConfigurationService, public common: CommonService, public datePipe: DatePipe, public selectSchool: SchoolselectionService) {
    ...
    ngOnInit() {
        ...
        this.selectSchool.allowChangeSchool(this.allowSelect);
    }
