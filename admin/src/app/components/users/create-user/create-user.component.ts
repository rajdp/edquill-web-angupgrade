...
export class CreateUserComponent implements OnInit {
  ...
  constructor(public route: ActivatedRoute, private formBuilder: UntypedFormBuilder, public commondata: CommonDataService, private toastr: ToastrService, public auth: AuthService, public category: CategoryService, public router: Router, public validation: ValidationService) {
  ...
  addUser() {
    if(this.accountForm.valid) {
      ...
      const data = {
        ...
        birthday: this.accountForm.value.dob.year + '-' + this.accountForm.value.dob.month +  '-' + this.accountForm.value.dob.day,
