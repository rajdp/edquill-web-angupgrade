...
export class ClassService {
    ...
    static { this.ɵfac = function ClassService_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || ClassService)(i0.ɵɵinject(i1.HttpClient), i0.ɵɵinject(i2.AuthService)); }; }
    static { this.ɵprov = /*@__PURE__*/ i0.ɵɵdefineInjectable({ token: ClassService, factory: ClassService.ɵfac, providedIn: 'root' }); }
}
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(ClassService, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
