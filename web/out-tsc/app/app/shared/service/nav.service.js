...
import * as i3 from "./newsubject.service";
import * as i4 from "./common.service";
export class NavService {
    constructor(window, auth, login, newSubject, common) {
        this.window = window;
        this.auth = auth;
        this.login = login;
        ...
        this.login.homeList.subscribe((res) => {
            if (res != '') {
                this.roleId = res;
            }
            if (res == '') {
    ...
    static { this.ɵfac = function NavService_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || NavService)(i0.ɵɵinject(WINDOW), i0.ɵɵinject(i1.AuthService), i0.ɵɵinject(i2.LoginService), i0.ɵɵinject(i3.NewsubjectService), i0.ɵɵinject(i4.CommonService)); }; }
    static { this.ɵprov = /*@__PURE__*/ i0.ɵɵdefineInjectable({ token: NavService, factory: NavService.ɵfac, providedIn: 'root' }); }
}
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(NavService, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
                ...
                type: Inject,
                args: [WINDOW]
            }] }, { type: i1.AuthService }, { type: i2.LoginService }, { type: i3.NewsubjectService }, { type: i4.CommonService }], { onResize: [{
            type: HostListener,
