...
export const appConfig = {
    providers: [
        ...
        provideAnimations(),
        importProvidersFrom(FormsModule, ReactiveFormsModule, PdfViewerModule, DragDropModule, PipesModule, calendarModule, NgbModule, ConnectionServiceModule, NgSelectModule, CustomMaterialModule, SocialLoginModule, SettingModule, StudentContentModule, AuthModule, MailboxModule, UsersModule, ToastrModule.forRoot()),
        NgbTooltipConfig,
        AuthGuardService,
        RoleGaurd,
        CommonDataService,
