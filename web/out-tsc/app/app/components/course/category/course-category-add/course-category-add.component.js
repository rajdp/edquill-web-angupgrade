...
import * as i10 from "../../../auth/tiny-mice/tiny-mice.component";
const _c0 = ["myInput"];
function CourseCategoryAddComponent_em_19_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "em", 20);
    i0.ɵɵtext(1, "Category Name is required");
    i0.ɵɵelementEnd();
} }
function CourseCategoryAddComponent_em_35_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "em", 20);
    i0.ɵɵtext(1, "Display Order Number is required");
    i0.ɵɵelementEnd();
} }
function CourseCategoryAddComponent_div_48_Template(rf, ctx) { if (rf & 1) {
    const _r2 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "div", 32)(1, "label", 33)(2, "span", 34);
    i0.ɵɵtext(3, "*");
    i0.ɵɵelementEnd();
    i0.ɵɵtext(4, "Cover Image");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(5, "div", 35)(6, "i", 36);
    i0.ɵɵlistener("click", function CourseCategoryAddComponent_div_48_Template_i_click_6_listener() { i0.ɵɵrestoreView(_r2); const ctx_r2 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r2.deleteImg()); });
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(7, "div", 37);
    i0.ɵɵelement(8, "img", 38);
    i0.ɵɵelementEnd()()();
} if (rf & 2) {
...
export class CourseCategoryAddComponent {
    ...
    addcategory() {
        if (this.form.valid) {
            if (this.errorMessage == '') {
                ...
                this.auth.postService(data, this.categoryId == '' ? urls.addCategory : urls.updateCategory).subscribe((successData) => {
    ...
    static { this.ɵfac = function CourseCategoryAddComponent_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || CourseCategoryAddComponent)(i0.ɵɵdirectiveInject(i1.AuthService), i0.ɵɵdirectiveInject(i2.FormBuilder), i0.ɵɵdirectiveInject(i3.Router), i0.ɵɵdirectiveInject(i3.ActivatedRoute), i0.ɵɵdirectiveInject(i4.ValidationService), i0.ɵɵdirectiveInject(i5.ToastrService), i0.ɵɵdirectiveInject(i6.EnvironmentService), i0.ɵɵdirectiveInject(i7.DomSanitizer)); }; }
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: CourseCategoryAddComponent, selectors: [["app-course-category-add"]], viewQuery: function CourseCategoryAddComponent_Query(rf, ctx) { if (rf & 1) {
            i0.ɵɵviewQuery(_c0, 5);
        } if (rf & 2) {
            let _t;
            i0.ɵɵqueryRefresh(_t = i0.ɵɵloadQuery()) && (ctx.myInputVariable = _t.first);
        } }, decls: 74, vars: 12, consts: [["myInput", ""], [1, "container-fluid", "card"], [1, "card-header", "my-2"], [1, "text-capitalize"], [1, "text-muted"], [1, "text-danger"], [1, "card-body"], [1, "mt-3", 3, "formGroup"], [1, "form-group", "row", "mt-1"], [1, "col-sm-2", "col-form-label"], [1, "col-sm-10"], ["formControlName", "category_name", "placeholder", "Category Name", 1, "form-control"], ["class", "error", 4, "ngIf"], [2, "visibility", "hidden"], [1, "main-content"], [3, "emitEditorValue", "height", "editorPatchValue", "hideMatEditor"], [1, "form-group", "row"], [1, "col-xl-2", "col-md-2"], [1, "col-xl-10", "col-md-10"], ["maxlength", "4", "formControlName", "display_order", "placeholder", "Enter Display Order Number", "type", "text", 1, "form-control", 3, "keypress"], [1, "error"], ["accept", ".png, .jpg, .jpeg,.webp", "type", "file", 1, "custom-upload-input", "col-md-12", "px-0", 3, "change"], [1, "color-grey", "mb-0", "font-weight-bold", 2, "font-size", "12px"], ["class", "form-group col-12 d-flex", 4, "ngIf"], [1, "mr-1", 2, "visibility", "hidden"], ["bindLabel", "subject_name", "bindValue", "subject_id", "formControlName", "subject_id", "placeholder", "Select Subject", "typeToSearchText", "", 3, "items", "multiple"], ["formControlName", "status", 1, "form-control"], ["value", "A"], ["value", "I"], [1, "card-footer"], [1, "button", "float-right", "btn", "btn-primary", "mb-2", 3, "click"], ["routerLink", "/course/category/list", 1, "float-right", "btn", "cancel", "mb-2", "mr-2"], [1, "form-group", "col-12", "d-flex"], [1, "col-sm-2", "col-form-label", 2, "visibility", "hidden"], [1, "mr-1", "text-danger"], [1, "col-xl-10", "col-md-10", "px-0"], ["title", "close", 1, "fa", "fa-times-circle", "close-icon", 3, "click"], [1, "files-list", "fit-img2"], ["alt", "", 1, "w-30", 3, "src"]], template: function CourseCategoryAddComponent_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵtemplate(19, CourseCategoryAddComponent_em_19_Template, 2, 0, "em", 12);
            i0.ɵɵelementEnd()();
            ...
            i0.ɵɵlistener("emitEditorValue", function CourseCategoryAddComponent_Template_app_tiny_mice_emitEditorValue_27_listener($event) { i0.ɵɵrestoreView(_r1); return i0.ɵɵresetView(ctx.editorValue($event)); });
            i0.ɵɵelementEnd()()()();
            ...
            i0.ɵɵlistener("keypress", function CourseCategoryAddComponent_Template_input_keypress_34_listener($event) { i0.ɵɵrestoreView(_r1); return i0.ɵɵresetView(ctx.numberValidate($event)); });
            i0.ɵɵelementEnd();
            i0.ɵɵtemplate(35, CourseCategoryAddComponent_em_35_Template, 2, 0, "em", 12);
            ...
            i0.ɵɵlistener("change", function CourseCategoryAddComponent_Template_input_change_44_listener($event) { i0.ɵɵrestoreView(_r1); return i0.ɵɵresetView(ctx.encodeImageFileAsURL($event)); });
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(46, "span", 22);
            i0.ɵɵtext(47, "Recommended Size 1MB");
            i0.ɵɵelementEnd()()();
            i0.ɵɵtemplate(48, CourseCategoryAddComponent_div_48_Template, 9, 1, "div", 23);
            i0.ɵɵelementStart(49, "div", 8)(50, "label", 9)(51, "span", 24);
            i0.ɵɵtext(52, "*");
            i0.ɵɵelementEnd();
            i0.ɵɵtext(53, "Subject");
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(54, "div", 10)(55, "ng-select", 25);
            i0.ɵɵtext(56, " [clearable]=\"false\"> ");
            i0.ɵɵelementEnd()()();
            i0.ɵɵelementStart(57, "div", 8)(58, "label", 9)(59, "span", 13);
            i0.ɵɵtext(60, "*");
            i0.ɵɵelementEnd();
            i0.ɵɵtext(61, " Status");
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(62, "div", 10)(63, "div", 14)(64, "select", 26)(65, "option", 27);
            i0.ɵɵtext(66, "Active");
            i0.ɵɵelementEnd();
            ...
            i0.ɵɵlistener("click", function CourseCategoryAddComponent_Template_button_click_70_listener() { i0.ɵɵrestoreView(_r1); return i0.ɵɵresetView(ctx.addcategory()); });
            i0.ɵɵtext(71);
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(72, "a", 31);
            i0.ɵɵtext(73, "Close");
            i0.ɵɵelementEnd()()()();
        } if (rf & 2) {
            i0.ɵɵadvance(4);
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(CourseCategoryAddComponent, { className: "CourseCategoryAddComponent" }); })();
//# sourceMappingURL=course-category-add.component.js.map