...
export class ReportModule {
    static { this.ɵfac = function ReportModule_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || ReportModule)(); }; }
    static { this.ɵmod = /*@__PURE__*/ i0.ɵɵdefineNgModule({ type: ReportModule }); }
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(ReportModule, [{
        type: NgModule,
        args: [{
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(ReportModule, { declarations: [AssessmentSummaryComponent, StudentGradeSummaryComponent, GradeReportComponent, MissedWorkReportComponent, StudentPerformanceReportComponent, ItemsReportComponent, AllReportComponent], imports: [CommonModule,
        NgbModule,
        Angular2SmartTableModule,
        ReactiveFormsModule,
        DropzoneModule,
        ...
        AngularMyDatePickerModule,
        ReportRoutingModule,
        TagInputModule, i1.CalendarModule, NgApexchartsModule,
        NgxDatatableModule,
        AuthModule,
        PipesModule,
        PdfViewerModule,
        CorporateschoolModule,
        StudentloginModule,
        SatReportModule], exports: [MissedWorkReportComponent,
        ItemsReportComponent] }); })();
